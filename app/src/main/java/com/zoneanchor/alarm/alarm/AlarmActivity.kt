...
class AlarmActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val appearance by app.container.settings.appearance.collectAsState(initial = com.zoneanchor.alarm.domain.AppearanceMode.SYSTEM)
            val palette by app.container.settings.palette.collectAsState(initial = com.zoneanchor.alarm.domain.ThemePalette.Anchor)
